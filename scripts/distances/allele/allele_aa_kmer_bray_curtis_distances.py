...
def process_sequences(csv_file, output_dir='kmer_aa_analysis', save_kmers=True):
...
if __name__ == "__main__":
    # Input file should be named unique_AA_alleles.csv
    csv_file = 'unique_AA_alleles.csv'
